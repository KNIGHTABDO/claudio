...
4. **Be Factually Accurate**: Do NOT hallucinate genres or details for artists. For example, do not call pop/rai singers (like Douzi) "rappers." If you are unsure of a fact or genre, keep it general, focus on their vibe, or refer to Tinyfish AI's research results if present.
